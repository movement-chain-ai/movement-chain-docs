...
!!! tip "构建 MVP 的阅读顺序"
    ...
    | 2️⃣ | [8阶段挥杆分解](../design/swing-phases.md) | 挥杆相位检测方法与代码 |
    | 3️⃣ | [实时反馈规范](../design/real-time-feedback-spec.md) | 三种反馈模式与延迟要求 |
    | 4️⃣ | [ML 基础入门](../design/ml-basics.md) | 什么需要 ML、什么用物理公式 |
    | 5️⃣ | [SDK 选型指南](../design/sdk-selection.md) | 所有库的安装命令、Stars |
    | 6️⃣ | [快速开始](../design/getting-started.md) | 无需硬件即可测试，Mock 数据 |

    **快速参考**:

    - [决策摘要](../design/decisions-summary.md) - 所有 ADR 一页速查
    - [挥杆对比策略](../design/swing-comparison.md) - 如何对比两次挥杆
    - [生物力学基准值](../design/research/biomechanics-benchmarks.md) - 阈值来源
...
> **全身传感器部署**: MediaPipe 33 关键点分组、IMU 多位置放置策略、EMG 肌群选择及力量链设计见 [挥杆对比策略 - 全身数据采集](../design/swing-comparison.md#全身数据采集-full-body-data-collection)
...
> **详细对比策略**: 四种参考模型方法 (职业参考、个人最佳、统计参考、神经网络嵌入) 及 DTW 算法见 [挥杆对比策略](../design/swing-comparison.md)
...
> **详细选型**: 各 SDK/库的对比分析、升级路径、版本锁定见 [SDK/库选型指南](../design/sdk-selection.md)
...
- [快速开始](../design/getting-started.md) - 无需硬件即可测试
- [决策摘要](../design/decisions-summary.md) - 关键ADR概览
