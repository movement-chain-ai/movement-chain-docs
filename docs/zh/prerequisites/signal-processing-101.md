...
#### 肌肉的电活动 Muscle Electrical Activity
...
#### 整流 Rectification {#rectification}
...
#### RMS 包络 RMS Envelope {#rms-envelope}
...
#### 完整流水线示例 {#preprocessing-pipeline}
...
| 步骤 | 英文 | 输入 | 输出 | 章节 |
|------|------|------|------|------|
| 1. 滤波 | Filtering | 原始 EMG | 去噪信号 | [1.2 滤波](#filtering) |
| 2. 整流 | Rectification | 去噪信号 | 全正信号 | [1.2 整流](#rectification) |
| 3. RMS 包络 | RMS Envelope | 全正信号 | 平滑曲线 | [1.2 RMS](#rms-envelope) |
| 4. 基线计算 | Baseline | 静息数据 | mean + std | [1.3](#baseline) |
| 5. 阈值判断 | Threshold | 平滑曲线 | 是否超过? | [1.4 阈值方法](#threshold-methods) |
| 6. 消抖 | Debounce | 阈值状态 | 持续确认 | [1.4 消抖](#debounce) |
