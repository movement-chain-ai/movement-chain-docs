...
$$
\text{节奏比} = \frac{\text{上杆时间}}{\text{下杆时间}} = \frac{0.85\,\text{s}}{0.25\,\text{s}} \approx 3{:}1
$$
...
**[角速度](../../reference/physics-glossary.md#1-角速度-angular-velocity) (Angular Velocity)** = 旋转的快慢，单位是 **度/秒 (°/s)**
...
- [线速度](../../reference/physics-glossary.md#2-线速度-linear-velocity)告诉你"走多快"（米/秒）
- [角速度](../../reference/physics-glossary.md#1-角速度-angular-velocity)告诉你"转多快"（度/秒）

一个每秒转 360° 的物体 = 每秒转一圈

### [角速度](../../reference/physics-glossary.md#1-角速度-angular-velocity)与[线速度](../../reference/physics-glossary.md#2-线速度-linear-velocity)的关系
...
- **v**：[线速度](../../reference/physics-glossary.md#2-线速度-linear-velocity)（m/s）
- **ω**：[角速度](../../reference/physics-glossary.md#1-角速度-angular-velocity)（相同）
- **r**：到旋转中心的距离
...
> **这就是为什么杆头速度最快**：虽然身体各部位的[角速度](../../reference/physics-glossary.md#1-角速度-angular-velocity)相同，但杆头距离旋转中心最远（r 最大），所以[线速度](../../reference/physics-glossary.md#2-线速度-linear-velocity)最大。
...
## 4.6 [角速度](../../reference/physics-glossary.md#1-角速度-angular-velocity)和[线速度](../../reference/physics-glossary.md#2-线速度-linear-velocity)递增的原因 — 运动链的物理学
...
!!! tip "可视化参考"
    📊 [TPI: Over the Top](https://www.mytpi.com/improve-my-game/swing-characteristics/over-the-top) 有详细视频和[挥杆路径](../../reference/golf-glossary.md#9-挥杆路径-swing-path)分析。
...
OTT 的后果取决于**[挥杆路径](../../reference/golf-glossary.md#9-挥杆路径-swing-path)**与**[杆面角度](../../reference/golf-glossary.md#8-杆面-clubface)**的组合：

#### [球路](../../reference/golf-glossary.md#10-球路-ball-flight)影响

| 杆面状态 | 球路结果 | 说明 |
|----------|----------|------|
| **杆面开放** (常见) | [右曲球 (Slice)](../../reference/golf-glossary.md#10-球路-ball-flight) | 外→内路径 + 开放杆面 = 强烈右旋 |
| **杆面关闭** | [左曲球 (Hook)](../../reference/golf-glossary.md#10-球路-ball-flight) 或左拉球 | 外→内路径 + 关闭杆面 = 左旋或左直飞 |
...
!!! info "职业球员的例外"
    Jim Furyk 等职业球员有轻微 OTT，但凭借出色的杆面控制仍能打出稳定[球路](../../reference/golf-glossary.md#10-球路-ball-flight)。OTT 的核心问题是**可控性差**和**一致性差**，而非一定失去距离。
...
│   └─────────────┘    └─────────────┘    └─────────────┘                     │
│                                                                              │
│   [采样率](../../reference/engineering-glossary.md#3-采样率-sampling-rate): 30fps         采样率: 1666Hz       采样率: 1000Hz                  │
│   精度: ±2°             精度: <10ms          精度: <5ms                      │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
三种传感器[采样率](../../reference/engineering-glossary.md#3-采样率-sampling-rate)不同，需要对齐到同一时间轴：
...
3. **了解系统**: 阅读 [传感器映射](../../design/architecture/sensor-metric-mapping.md) 了解我们的测量能力
