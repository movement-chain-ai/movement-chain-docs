...
!!! tip "关键认知"
    节奏比是**诊断工具**，不是训练目标。每个人有自己的自然节奏，关键是保持一致。

---

## 1.5 [引导侧与后侧](../../reference/golf-glossary.md#3-引导侧与后侧-lead-trail-side) Lead Side & Trail Side {#14-引导侧与后侧-lead-side--trail-side}
...
## 2.3 [X-Factor Stretch](../../reference/golf-glossary.md#5-x-factor-stretch) {#23-x-factor-stretch职业球手的秘密武器}
...
### [杆头速度](../../reference/golf-glossary.md#4-杆头速度-clubhead-speed) (线速度) {#杆头速度-线速度}
...
| 符号 | 含义 | 单位 |
|------|------|------|
| L | [角动量](../../reference/physics-glossary.md#4-角动量-angular-momentum) | kg·m²/s |
| I | [转动惯量](../../reference/physics-glossary.md#3-转动惯量-moment-of-inertia) | kg·m² |
| m | 质量 | kg |
| r | 有效半径（质心到旋转轴的距离） | m |
| ω | 角速度 | rad/s |
...
3. **了解系统**: 阅读 [传感器映射](../../design/architecture/sensor-data-processing.md) 了解我们的测量能力
