...
> 详见：[数据流 § Stage 5](../design/architecture/data-processing/data-pipeline.md) — Kinematic Prompt 在系统中的位置
...
- [数据流](../design/architecture/data-processing/data-pipeline.md) - Kinematic Prompt 实际应用
