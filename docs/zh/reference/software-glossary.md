...
> 详见：[关键决策 2025-12 § 部署策略](../design/architecture/architecture-decisions-2025-12-23.md#5-部署策略决策)
...
- [关键决策 2025-12 § 部署策略](../design/architecture/architecture-decisions-2025-12-23.md#5-部署策略决策) - 边缘计算与云端部署决策
