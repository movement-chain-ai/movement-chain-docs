...
| 9 | [杆面](#9-杆面-clubface) | Clubface | 球杆击球的平面，其角度决定球的初始方向和侧旋 |
...
## 9. 杆面 (Clubface) {#9-杆面-clubface}

**一句话定义：** 杆面是球杆头上用来击打球的平面，其角度决定球的初始方向和侧旋。
...
击球瞬间，杆面相对于目标线的朝向决定球的初始方向和侧旋（以右手球员为例）：

| 状态 | 英文 | 杆面朝向 | 对球路的影响 |
|------|------|----------|--------------|
| **开放** | Open | 朝向目标右侧 | 球向右飞/产生右旋 |
| **关闭** | Closed | 朝向目标左侧 | 球向左飞/产生左旋 |
| **方正** | Square | 正对目标 | 直飞 |
...
| 因素 | 影响 |
|------|------|
| **杆面角度** | 决定球的初始方向（约 75-85%） |
| **路径与杆面的差异** | 决定侧旋方向和程度 |

```text
例如 Over-the-Top + 开放杆面：
    路径：外→内 (Out-to-In)
    杆面：朝右（相对路径开放）
    结果：右曲球 (Slice)
```
...
> 详细的球路与杆面关系见：[球路 (Ball Flight)](#8-球路-ball-flight)
>
> Over-the-Top 与杆面的关系见：[生物力学入门 - Over-the-Top](../design/foundations/biomechanics-101.md#63-over-the-top-从外侧下杆)
