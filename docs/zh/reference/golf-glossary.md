...
| 8 | [杆面](#8-杆面-clubface) | Clubface | 球杆击球的平面，决定球的起飞方向 |
| 9 | [挥杆路径](#9-挥杆路径-swing-path) | Swing Path | 杆头在触球瞬间的移动方向 |
| 10 | [球路](#10-球路-ball-flight) | Ball Flight | 球的弯曲方向，由杆面和路径的差值决定 |
...
![杆面角度示意图](../images/clubface-angles.jpg){ width="400" }
...
## 9. 挥杆路径 (Swing Path) {#9-挥杆路径-swing-path}
...
![挥杆路径示意图](../images/swing-path-types.jpg){ width="500" }
...
Over-the-Top (OTT) 是导致**外→内路径**的最常见原因：
...
## 10. 球路 (Ball Flight) {#10-球路-ball-flight}
...
![Ball Flight Laws](../images/ball-flight-laws.jpg){ width="500" }

| 杆面 | 路径 | 起飞方向 | 弯曲 | 球路名称 |
|------|------|----------|------|----------|
| 关闭 | 外→内 | 左 | ← 左曲 | **Pull-Hook** (C) |
| 关闭 | 方正 | 左 | 不弯 | **Pull** (B) |
| 关闭 | 内→外 | 左 | → 右曲 | **Straight Draw** (A) |
| 方正 | 外→内 | 直 | → 右曲 | **Straight Fade** (D) |
| 方正 | 方正 | 直 | 不弯 | **Straight** (E) |
| 方正 | 内→外 | 直 | ← 左曲 | **Straight Draw** (G) |
| 开放 | 外→内 | 右 | → 右曲 | **Push-Slice** (F) |
| 开放 | 方正 | 右 | 不弯 | **Push** (H) |
| 开放 | 内→外 | 右 | ← 左曲 | **Push-Draw** (I) |

### 常见球路评价

| 球路 | 英文 | 弯曲方向 | 评价 |
|------|------|----------|------|
| **右曲球** | Slice | 严重右弯 | ❌ 最常见的业余问题 |
| **小右曲** | Fade | 轻微右弯 | ✅ 职业球员常用 |
| **小左曲** | Draw | 轻微左弯 | ✅ 能增加距离 |
| **左曲球** | Hook | 严重左弯 | ❌ 不可控 |
...
> Over-the-Top 分析见：[生物力学入门 - Over-the-Top](../design/foundations/biomechanics-101.md#63-over-the-top-外侧下杆)
