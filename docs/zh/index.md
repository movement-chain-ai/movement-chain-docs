...
4. [数据流](design/architecture/data-processing/data-pipeline.md) → Kinematic Prompts
5. [传感器-指标映射](design/architecture/data-processing/metrics-calculation.md) → Python 代码示例
