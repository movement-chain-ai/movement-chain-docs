...
!!! success "项目决策"
    详见 [ADR-0002: LSM6DSV16X IMU 选型](../decisions/0002-lsm6dsv16x-imu.md)
...
详细供应商信息请参见 [IMU 供应商大全](../suppliers/imu.md)

---

## 相关资源

- [ADR-0002: LSM6DSV16X 选型决策](../decisions/0002-lsm6dsv16x-imu.md)
- [硬件比较](../resources/hardware-comparison.md)
- [传感器硬件指南](../guides/sensor-hardware.md)
- [IMU 供应商](../suppliers/imu.md)
