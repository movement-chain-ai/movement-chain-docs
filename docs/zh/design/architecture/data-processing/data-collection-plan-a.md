...
| 优先级 | 错误类型 | 触发条件 | 数据源 | 次数/人 | 动作指导 |
|-------|---------|---------|--------|--------|---------|
| P0 | 倒序运动链 | 前臂先于核心激活 (gap < -20ms) | EMG | 2次 | 刻意用手臂启动下杆 |
| P0 | 过度手臂挥杆 | Forearm/Core ratio > 1.3 | EMG | 2次 | 核心不发力，纯手臂挥 |
| P1 | X-Factor 不足 | X-Factor < 20° | Vision | 1次 | 最小化肩髋分离 |
| P1 | 节奏过快 | Downswing < 0.20s | IMU | 2次 | 尽可能快地下杆 |
| P1 | 节奏过慢 | Downswing > 0.40s | IMU | 1次 | 刻意放慢下杆速度 |
| P1 | 早释放 | Wrist release < 40% downswing | IMU | 2次 | 下杆初期就打开手腕 |
