...
|-------|---------|---------|--------|--------|--------|---------|
| P0 | 倒序运动链 | 前臂先于核心激活 (gap < -20ms) | EMG | 1次 | 10次 | 刻意用手臂启动下杆 |
| P0 | 过度手臂挥杆 | Forearm/Core ratio > 1.3 | EMG | 1次 | 10次 | 核心不发力，纯手臂挥 |
| P1 | X-Factor 不足 | X-Factor < 20° | Vision | 1次 | 10次 | 最小化肩髋分离 |
| P1 | 节奏过快 | Downswing < 0.20s | IMU | 1次 | 10次 | 尽可能快地下杆 |
| P1 | 节奏过慢 | Downswing > 0.40s | IMU | 0.5次 | 5次 | 刻意放慢下杆速度 |
| P1 | 早释放 | Wrist release < 40% downswing | IMU | 0.5次 | 5次 | 下杆初期就打开手腕 |
