...
> 📚 **时间同步原理**: [信号处理入门 §5-6](../../prerequisites/signal-processing-101.md#5-多传感器时间同步) — 时钟对齐、插值方法、Impact 事件同步
...
#### 1.3.2 Sensor Hub 时间同步架构 {#sensor-hub-架构-2025-12-推荐}
...
#### 1.4.1 Vision 指标 (从 MediaPipe 计算)
