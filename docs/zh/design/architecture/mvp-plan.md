...
> 📐 **详细规格**: 三个训练场景的完整定义见 [三个训练场景](../specs/three-training-scenarios.md)
...
> 📐 **详细规格**: [§7.2 诊断规则](#72-mvp-6-条诊断规则) | [三个训练场景](../specs/three-training-scenarios.md)
...
| **Phase 4** | E2E 延迟 | <500ms | [三个训练场景](../specs/three-training-scenarios.md) |
...
| **训练场景** | [三个训练场景](../specs/three-training-scenarios.md) | 3个场景: 站姿检查 / 慢动作训练 / 全速分析 |
