...
> 📐 **详细规格**: 三种训练场景的完整定义见 [训练反馈规范](../specs/training-feedback.md)
...
> 📐 **详细规格**: [§7.2 诊断规则](#72-mvp-6-条诊断规则) | [训练反馈规范](../specs/training-feedback.md)
...
| **Phase 4** | E2E 延迟 | <500ms | [训练反馈规范](../specs/training-feedback.md) |
...
| **Mode 1/2** | [训练反馈规范](../specs/training-feedback.md) | 站姿检查 + 慢动作训练 | Post-MVP |
