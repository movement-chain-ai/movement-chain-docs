...
Movement Chain AI 的核心创新是**三模态传感器融合**：视频、IMU、EMG 三路数据同时采集、融合分析。
...
> 详见 [关键决策 2025-12](../decisions/architecture-decisions-2025-12-23.md#43-硬件购买清单--2025-12-23-验证)
