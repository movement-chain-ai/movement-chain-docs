...
│   ┌─ 核心驱动群 (躯干旋转) ──────────────────────────────────────┐  │
│   │                                                            │  │
│   │   髋部 (X-Factor, O-Factor, 对应 EMG 竖脊肌/腹外斜肌):        │  │
│   │   ├── 23: left_hip        (左髋)                           │  │
│   │   └── 24: right_hip       (右髋)                           │  │
│   │                                                            │  │
...
**Vision 关键点与 EMG 肌群对照** (基于运动链):

| 运动链层级 | Vision 关键点 | 对应 EMG 肌群 | 生物力学功能 |
|-----------|--------------|--------------|-------------|
| **上肢控制** | 15, 16 (手腕) | 前臂屈肌/伸肌 | 握杆压力、杆面控制 |
| **上肢控制** | 13, 14 (手肘) | 肱二头肌/三头肌 | 手臂折叠、释放时机 |
| **上肢控制** | 11, 12 (肩膀) | 三角肌、胸大肌 | 上杆幅度、下杆驱动 |
| **核心驱动** | 11, 12 + 23, 24 | 腹外斜肌 | 躯干旋转 (X-Factor) |
| **核心驱动** | 23, 24 (髋部) | 竖脊肌 | 脊柱稳定、背部负荷 |
| **下肢稳定** | 23, 24 (髋部) | 臀大肌/臀中肌 | 骨盆旋转扭矩 |
| **下肢稳定** | 25, 26 (膝盖) | 股四头肌 | 膝盖稳定性 |
| **下肢稳定** | 27, 28 (脚踝) | - | 站位基础 |

> 详见 [sEMG 研究 §5.1](../../reference/semg-research-2024-2025.md#51-肌肉选择与传感器放置基于动力链的策略) — 肌肉选择与传感器放置策略
...
| 数据类型 | 原点 (0 值) | 说明 |
|---------|------------|------|
| **accel_x/y/z** | 传感器静止时 | 静止时只有重力加速度 (accel_y ≈ 9.8 m/s²) |
