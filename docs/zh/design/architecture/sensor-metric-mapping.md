...
│   │   └── 臀大肌/臀中肌 — 骨盆旋转扭矩 + 侧向稳定                   │ │
│   │                                                            │ │
│   │   计算: 躯干旋转 = 肩膀(11,12) - 髋部(23,24) 角度差            │ │
│   │                                                            │ │
│   └────────────────────────────────────────────────────────────┘│
│                                                                 │
│   ┌─ 纯 Vision 关键点 (无对应 EMG) ────────────────────────────┐   │
│   │                                                            │ │
│   │   膝盖 (姿态分析):  25, 26                                  │ │
│   │   脚踝 (站位宽度):  27, 28                                  │ │
│   │                                                            │ │
...
**Vision 关键点与 EMG 肌群对照** (基于 sEMG 研究 §5):

| 运动链层级 | Vision 关键点 | 对应 EMG 肌群 | 生物力学功能 |
|-----------|--------------|--------------|-------------|
| **控制与释放群** | 15, 16 (手腕) | 前臂屈肌/伸肌 | 握杆压力、杆面控制 |
| **核心驱动群** | 11, 12 + 23, 24 | 腹外斜肌 (EO) | 躯干旋转 (X-Factor) |
| **核心驱动群** | 23, 24 (髋部) | 竖脊肌 (ES) | 脊柱稳定、背部负荷 |
| **动力稳定群** | 23, 24 (髋部) | 臀大肌/臀中肌 | 骨盆旋转扭矩、侧向稳定 |
