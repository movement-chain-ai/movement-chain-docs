...
传统 2D 视频只能从单一角度观看，而 3D 动画可以**任意旋转视角**。

学习者可以从正面、侧面、俯视等多角度观察同一个动作，理解空间关系。

例如髋部旋转在正面看是左右移动，但从俯视角度才能真正看清旋转幅度。

3D 呈现让抽象的生物力学概念变得可触可感。

#### 2.2.2 肌肉与骨骼双层显示

界面同时展示**肌肉层**和**骨骼层**，两者可以叠加或切换。

骨骼层展示关节角度、旋转轴心、运动轨迹等几何信息。

肌肉层展示哪些肌肉群在发力、肌肉的拉伸和收缩状态。

这种双层设计帮助学习者理解"骨骼怎么动"和"肌肉怎么配合"的关系。

每个动作要点都可以在对应的肌肉或骨骼上标注指标，比如髋部旋转角度标注在骨盆上，核心发力标注在腹肌群上。

#### 2.2.3 重力线与平衡参考

动画中有一条**垂直重力线（Gravity Line）**贯穿人体。

重力线显示身体重心相对于双脚支撑面的位置，帮助判断平衡状态。

挥杆过程中重力线会随重心转移而移动，理想状态是始终保持在支撑范围内。

这条线让学习者直观理解"重心转移"这个抽象概念。

#### 2.2.4 实时对错对比

动画采用**左右分屏或叠加对比**的方式，同时展示正确动作和错误动作。

两个动画**同步播放**，让学习者在同一时刻看到"应该怎么做"和"常见错误是什么"。

对比不是静态截图，而是动态的、实时的，每一帧都能看到差异。

例如展示"早伸展（Early Extension）"时，左边是髋部保持稳定的正确动作，右边是髋部前冲的错误动作，学习者可以清晰看到两者在下杆过程中逐渐拉开的差距。

这种实时对比比单独看正确动作更有效，因为学习者往往不知道自己错在哪里。

#### 2.2.5 慢速动画与重影设计

动画播放速度经过精心调整，**不快不慢**，让学习者有足够时间观察细节。

关键是**重影（Ghost/Onion Skin）设计**：动画中会保留前几帧的半透明残影。

重影让学习者可以在单帧画面中看到动作的**连续变化轨迹**。

例如下杆过程中，重影清晰显示髋部如何领先肩部旋转，形成 X-Factor Stretch。

这种设计比单纯的慢动作更有效，因为它在时间维度上"压缩"了动作序列，方便对比。
