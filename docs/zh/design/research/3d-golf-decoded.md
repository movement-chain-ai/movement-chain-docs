...
动画播放**流畅丝滑**，配合讲解节奏调整速度。关键动作点会**暂停或慢放**，配合文字和语音讲解，让学习者理解要点。
...
| | |
|:---:|:---:|
| ![肌肉骨骼叠加](images/muscle-skeleton-overlay-1.jpg){ width="300" } | ![肌肉骨骼叠加](images/muscle-skeleton-overlay-2.jpg){ width="300" } |
