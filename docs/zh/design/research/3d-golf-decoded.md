...
| 关键信息标注方法 | 学习他们的**半透明线条、角度圆、轨迹线**等标注设计 |
...
虽然我们的产品覆盖了全部三个阶段，但**认知阶段同样重要**——用户在练习时也需要理解"为什么要这样做"。我们在指导用户练习时同样提供**视觉和听觉反馈**，因此也需要致力于**提高用户的认知**。他们在认知阶段的界面设计值得参考：

| 借鉴维度 | 他们的做法 | 我们的应用场景 |
|---------|-----------|---------------|
| **视觉反馈** | 3D动画、肌肉高亮、角度标注 | 训练实时反馈界面、动作回放 |
| **信息层次** | 半透明叠加、不遮挡主体 | 实时数据叠加在动作视频上 |
| **对比展示** | 正确vs错误、多角度同步 | 用户动作vs标准动作对比 |
| **关键点强调** | 暂停标注、高亮发力肌群 | 实时提示需要纠正的部位 |
| **教学直观性** | 轨迹线、角度圆、文字标签 | 让用户理解"为什么要这样做" |
...
6. **全阶段覆盖**: 我们覆盖运动技能习得的全部三个阶段，但认知阶段的界面设计可向他们学习
