...
| 数据如何变成用户反馈? | 规则引擎判断 + AI 翻译，不是纯 AI | [§2 反馈生成架构](#2-反馈生成架构) |
...
1. **核心判断用规则**: 保证准确性，不会"说错话"
2. **翻译用 LLM**: 灵活、自然、支持多语言
3. **高级功能用 AI**: 个性化、趋势分析、可选启用
...
文档版本: v1.0 | 作者: Movement Chain AI Team | 最后更新: 2025-12-20
