...
!!! info "为什么用"峰值角速度"而非"击球"？"
    **运动学定义 (Kinematic Definition)**:
    ...
    详见: [信号处理入门 - IMU 相位检测](../architecture/data-processing/signal-processing.md#part2-imu)
...
graph TD
    ...
    A --> C[assessment-mode.md]
    A --> D[four-comparison-methods.md]
...
| 相关文档 | 内容 | 本文档提供 |
|---------|------|-----------|
| [系统架构](../architecture/system-design.md) | MVP 管道架构 | 阶段检测算法详情 |
| [评估模式](modes/assessment-mode.md) | 反馈触发条件 | 阶段检测作为触发点 |
