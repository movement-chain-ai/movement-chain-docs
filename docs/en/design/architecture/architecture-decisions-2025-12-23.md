...
**Current Status**: `metrics-calculation.md §8` already contains complete Mock data generation code
...
> **Authoritative Source**: [data-pipeline.md §1.2](./data-pipeline.md) defines complete time synchronization specs.
...
| Item | Status | Description | Deadline |
|------|--------|-------------|----------|
| Update data-pipeline.md | ⏳ Pending | Sync BLE jitter research to authoritative doc | Next week |
...
|----------|---------|--------------|
| **[data-pipeline.md](./data-pipeline.md)** | **Data flow & time sync** | **⭐ Authoritative source** |
...
> **Documentation Priority**: `data-pipeline.md` is the **single authoritative source** for data flow and time synchronization.
