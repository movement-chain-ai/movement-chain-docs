...
<figure markdown="span">
  ![P1-P10 Swing Position Classification System](../../images/PClassificationSystemGolfSwing.png){ width="100%" }
...
<figure markdown="span">
  ![X-Factor Rotation Angle](../../images/x-factor-rotation.png){ width="300" }
...
|:--:|:--:|
| ![X-Factor Rotation Angle](../../images/x-factor-rotation.png){ width="300" } | ![X-Factor Stretch](../../images/x-factor-stretch.png){ width="300" } |
...
- ![S-O Factor Top](../../images/s-o-factor-top.png)

    **Top of Backswing**

- ![S-O Factor Impact](../../images/s-o-factor-impact.png)

    **Impact**

- ![S-O Factor Follow Through](../../images/s-o-factor-follow-through.png)

    **Mid Follow-through**

- ![S-O Factor Finish](../../images/s-o-factor-finish.png)
...
![Early Extension Illustration](../../images/early-extension.png){ width="500" }
...
|:--:|:--:|
| ![Casting Wrong](../../images/casting-wrong.png){ width="350" } | ![Correct Release](../../images/casting-correct.png){ width="350" } |
...
![❌ Reverse Pivot Illustration](../../images/reverse-pivot.png){ width="500" }
