...
**Important**: The research documents have been reorganized!

---

## ⚠️ Documentation Has Moved

Research documents are no longer organized by source type. They have been **consolidated into topic-based comprehensive guides** for better usability.

### New Location: [`docs/guides/`](../guides/index.md)

---

## Quick Navigation to New Guides
...
├── sensor-hardware.md           ← Everything about sensors
└── ... (6 comprehensive guides)
```

**Solution**: Working on pose estimation? Read ONE comprehensive guide! 😊
...
- **Mobile development**: [mobile-development.md](../guides/mobile-development.md)
- **Datasets**: [datasets-benchmarking.md](../guides/datasets-benchmarking.md)
...
**Migration completed**: All research consolidated into topic-based guides
